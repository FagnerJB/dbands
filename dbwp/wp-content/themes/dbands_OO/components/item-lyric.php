...
<li class="size-full text-zinc-800 <?php echo $first ? 'aspect-video col-span-2' : 'aspect-row md:aspect-feed' ?>">
   <article class="size-full">
      <a class="flex flex-col justify-end md:justify-between py-2 px-3 size-full bg-amber-400 hover:bg-yellow-300 focus:bg-yellow-300" href="<?php echo $Lyric->get('link') ?>" title="<?php echo $title ?>" rel="bookmark">
