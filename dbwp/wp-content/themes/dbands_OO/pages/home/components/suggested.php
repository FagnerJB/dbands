      ...
      ?>
         <li class="aspect-row md:aspect-feed overflow-hidden text-zinc-200">
            <a class="group relative" href="<?php echo $suggested->term->get('link') ?>">
               <img class="size-full object-cover object-center group-hover:scale-110 group-focus:scale-110 transition-all" src="<?php echo $suggested->term->get_cover() ?>" alt="" loading="lazy">
               <div class="absolute inset-0 z-0 flex flex-col justify-between py-2 px-3 bg-zinc-950/50 group-hover:bg-zinc-950/80 group-focus:bg-zinc-950/80 text-shadow-sm transition-all">
                  <div class="grow">
