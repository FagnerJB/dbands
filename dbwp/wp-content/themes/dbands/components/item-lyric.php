...
?>
<li
    class="size-full text-zinc-800 <?php echo $first ? 'aspect-video col-span-2' : 'aspect-row md:aspect-feed'; ?>">
   <article class="size-full">
      <a class="flex flex-col justify-end md:justify-between py-2 px-3 size-full bg-amber-400 hover:bg-yellow-300 focus-visible:bg-yellow-300"
         ...
         <div>
            <h3>
               <div class="text-xs md:text-lg line-clamp-3">
            ...
            <?php if (is_search()) { ?>
            <div class="text-xxs md:text-sm">Traduzido por
               <?php echo $Lyric->get('tradutor'); ?>
            </div>
            <?php } ?>
         </div>
      </a>
