   ...
   <li class="relative aspect-video overflow-hidden">
      <a class="group block"
         ...
         <div
            ...
            <div class="absolute top-1.5 right-2 text-xs md:text-md">
               <i class="fa-brands fa-youtube"></i>
            </div>
            <div
                 class="flex flex-col justify-end overflow-hidden h-14 group-hover:h-26 group-focus-visible:h-26 transition-all">
               <h3
                   class="font-semibold text-xs md:text-md line-clamp-2 group-hover:line-clamp-4 group-focus-visible:line-clamp-4">
