...
class Register
{
   public function __construct()
   {
      ...
      add_filter('cav_head_metatags', [$this, 'sets_metatags']);
   ...
   public function register(): void
   {
      register_post_type('lyric', [
         'labels' => [
            'name'          => 'Traduções',
            'archives'      => 'Traduções de letras em alemão',
            'singular_name' => 'Tradução',
         ],
         'description'   => 'Todas as letras traduzidas do alemão já publicadas',
         'public'        => true,
         'has_archive'   => true,
         'menu_position' => 5,
